    ...
    return (
		<div class="container mx-auto lg:px-20 xl:px-20 px-4 min-h-90" id="aboutussection">
			<div class=" flex-wrap  justify-center lg:mt-20 lg:mt-20 mt-10 text-left">
				<div class="w-full sm:full md:w-full md:px-20 md:py-32 md:flex md:flex-col md:justify-center md:items-center lg:w-1/4 xl:w-5/12 mb-4 rounded-3xl gap-x-7 bg-[#1e2029] lg:p-20 xl:p-20 p-5 lg:m-4 xl:m-4 mr-0 xl:ml-20 xl:float-right">
				...
				<div class="w-full sm:full md:px-20 md:flex md:flex-col md:justify-center md:items-center md:py-32 item-center md:w-full lg:w-1/4 xl:w-5/12 mb-4 rounded-3xl gap-x-7 bg-[#1e2029] p-7 xl:p-20 lg:p-20 m-4 ml-0">
