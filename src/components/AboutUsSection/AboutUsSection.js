		...
		<div class="container mx-auto lg:px-20 xl:px-20 px-4 min-h-90" id="aboutussection">
			<div class=" flex-wrap  justify-center lg:mt-20 lg:mt-20 mt-10 text-left">
				<div class="w-full xl:pl-4 xl:items-end sm:full md:w-full md:px-0 md:py-0 md:flex md:flex-col md:justify-center md:items-center lg:py-0 xl:py-0 lg:px-0 xl:px-0 lg:w-full  xl:w-2/4  gap-x-7 lg:m-0 xl:m-0 mr-0 xl:ml-0 xl:float-right">
					<div class="bg-[#1e2029] xl:w-full lg:w-full  rounded-3xl p-8 lg:flex  xl:flex-col lg:flex-col xl:flex lg:px-[42px] py:40 xl:px-[42px] lg:py-[78px]  md:px-[42px] md:py-[78px] xl:py-[94px]">
