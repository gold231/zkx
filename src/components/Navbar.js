    ...
    <div class="container mx-auto xl:px-32 lg:px-32 md:px-32 px-5">
      <nav class="text-white lg-pt-5 xl:pt-5 pt-5 border-gray-200 sm:px-4 rounded dark:bg-gray-800">
        <div class="container flex flex-wrap justify-between  mx-auto">
          ...
          <button onClick={handleMobileClick} data-collapse-toggle="mobile-menu" type="button" class="    pt-4 absolute right-5 inline-flex items-center p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-2" aria-expanded="false">
          ...
          <div  class={isMobileOpen? 'w-full md:block md:w-auto' : 'hidden w-full md:block md:w-auto' }   id="mobile-menu">
            <ul class="md:left-8 bg-[#111d1f] w-11/12 lg:w-full xl:w-full md:w-full md:pt-5 md:relative md:right-12 absolute left-4 lg:relative xl:relative xl:right-30 lg:right-15 text-left  md:bg-transparent rounded-lg lg:bg-transparent xl:bg-transparent flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
              <li>
                <a href="#" class="block py-2 pr-4 pl-3 text-white text-[16px] font-sin rounded bg-[#23242D] md:bg-transparent xl:bg-transparent lg:bg-transparent md:white md:p-0 dark:text-white mt-1 rounded-lg " aria-current="page"  onClick={() =>  scroller.scrollTo('aboutussection', {
                  duration: 800,
                  delay: 0,
              ...
              <li>
                <a href="#" class="bg-[#23242D] md:bg-transparent text-[16px] font-sin xl:bg-transparent lg:bg-transparent block py-2 pr-4 pl-3 text-white border-gray-100 mt-1 rounded-lg  hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                ...
                {isopen == true && 
                  <div id="dropdownNavbar"  class="top-28 xl:top-12 lg:top-12 md:top-12 pt-1 xl:pt-0 lg:pt-0 md:pt-0 left-0 md:left-48 xl:left-48 lg:left-48 z-40 absolute w-full lg:w-44 xl:w-44 md:w-44 lg:absolute xl:absolute md:absolute  md:right-5  xl:right-5 lg:right-5 z-10 text-white text-base list-none rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                    <ul class="py-1" aria-labelledby="dropdownLargeButton">
                      <div class="px-2 py-2 bg-[#1E2029] rounded-md shadow dark-mode:bg-[#1E2029] lg:bg-[#1E2029] xl:bg-[#1E2029]  md:bg-[#1E2029] bg-[#23242D] ">
                        <a class="w-full block px-4 py-2 mt-2 text-white text-[16px] font-sin inline-flex " href="#"><img src="./assets/img/twitter.png" class="max-w-full h-auto object-center pr-5" alt="..." />Twitter</a>
                        <a class="w-full block px-4 py-2 mt-2 text-white text-[16px] font-sin inline-flex" href="#"><img src="./assets/img/discord.png" class="max-w-full h-auto object-center pr-5" alt="..." />Discord</a>
                        <a class="w-full lock px-4 py-2 mt-2 text-white text-[16px] font-sin inline-flex" href="#"><img src="./assets/img/medium.png" class="max-w-full h-auto object-center pr-5" alt="..." />medium</a>
