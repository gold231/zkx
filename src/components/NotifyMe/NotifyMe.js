    ...
    return (
		...
		<div class="mt-20  xl:mt-40 lg:mt-40 bg-[#1e2029] rounded-3xl xl:p-28 	pb-20  	pt-20 ">
			...
			<div class="xl:flex md:flex items-center justify-center ">
				<div class="xl:flex border-gray-200 rounded pt-12 pl-12 ">
...
<input type="submit"  class="bg-[#00ff62] hover:bg-blue-700 text-white font-bold py-3 ml-2 xl:w-32 lg:w-32 px-4 mt-2 w-10/12 text-[#000] rounded items-center text-center" value="Notify Me" />
