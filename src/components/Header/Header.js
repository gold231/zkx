  ...
  return (
    <>
      ...
      <p class=" text-center pt-12 pb-12">
        <button align="center" class="bg-[#00ff62] hover:bg-white text-white font-bold py-2 px-4 text-[#000] rounded-full items-center text-center" onClick={() =>  scroller.scrollTo('notifysection', {
          duration: 800,
          delay: 0,
